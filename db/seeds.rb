...
u1 = User.new(name: "tomyuk", email: "tom.yuk.g@gmail.com", password: "hogehoge")
u1.save(validate: false)

u2 = User.new(name: "test", email: "test@example.com", password: "hogehoge")
...
(1..N_USER).each do |i|
  u = User.new(name: "test#{i}", email: "test#{i}@dot.com")
  u.password = 'hogehoge'
